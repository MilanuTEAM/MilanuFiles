...
DevAbs:del(Milanu.."Abs:Lock:AutoFile")
end
...
DevAbs:set(Milanu.."Abs:Lock:AutoFile",true) 
end 
end

if (text and not DevAbs:get(Milanu.."Abs:Lock:AutoFile")) then
Time = DevAbs:get(Milanu.."Abs:AutoFile:Time")
if Time then 
...
BasicConstructors = DevAbs:smembers(Milanu..'Abs:BasicConstructor:'..v)
Constructors = DevAbs:smembers(Milanu..'Abs:Constructor:'..v)
...
DevAbs:set(Milanu.."Abs:AutoFile:Time",os.date("%x"))
end
else 
DevAbs:set(Milanu.."Abs:AutoFile:Time",os.date("%x"))
end
