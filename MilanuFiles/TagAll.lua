...
if DeAlsh:get(Milanu.."Alsh:TagAll:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
De_Alsh(msg.chat_id_, msg.id_, 1, '⌁︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DeAlsh:setex(Milanu..'Alsh:TagAll:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
