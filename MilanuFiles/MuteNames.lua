...
if DeAlsh:get(Milanu.."Alsh:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DeAlsh:sadd(Milanu.."Alsh:Mute:Names"..msg.chat_id_, MuteName)
end
...
DeAlsh:srem(Milanu.."Alsh:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DeAlsh:del(Milanu.."Alsh:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DeAlsh:smembers(Milanu.."Alsh:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DeAlsh:get(Milanu.."Alsh:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
MilanuName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if MilanuName then 
MilanuNames = DeAlsh:smembers(Milanu.."Alsh:Mute:Names"..msg.chat_id_) or ""
if MilanuNames and MilanuNames[1] then 
for i=1,#MilanuNames do 
if MilanuName:match("(.*)("..MilanuNames[i]..")(.*)") then 
...
DeAlsh:set(Milanu.."Alsh:Lock:MuteNames"..msg.chat_id_,true)
end
...
DeAlsh:del(Milanu.."Alsh:Lock:MuteNames"..msg.chat_id_)
end
end
end
