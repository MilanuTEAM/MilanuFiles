...
if not DeAlsh:get(DeProx..'Alsh:Lock:Reply'..msg.chat_id_) then
...
elseif AlshConstructor(msg.sender_user_id_, msg.chat_id_) then
...
DeProxTEAM =  "آخلُِآقٌڪڪ لُِڪڪ 𖠙 😒🔪"
De_Alsh(msg.chat_id_, msg.id_, 1, DeProxTEAM, 1, 'md') 
return false
end
if text == 'السلام عليكم' or text == 'سلام عليكم' then 
DeProxTEAM =  "ياھَہّلْاا ۅﻋ̝̚لْيڪْم الْﺳ̭͠ لْام 𖠙 🤤♥️"
De_Alsh(msg.chat_id_, msg.id_, 1, DeProxTEAM, 1, 'md') 
return false
end
if text == '😭💔' or text == '😭😭' or text == '😭😭😭' or text == '😿💔' or text == '😭😭😭' or text == '😭😭😭😭' then 
DeProxTEAM =  "مآآعٍآشُ آلُِي يزعٍلُِڪڪ 𖠙 😏♥️"
De_Alsh(msg.chat_id_, msg.id_, 1, DeProxTEAM, 1, 'md') 
return false
end
if text == '🌚💔' or text == '💔🌚' or text == '🚶‍♂💔' or text == '💔' or text == '😔💔' or text == '🚶‍♀💔' or text == '😭' then 
DeProxTEAM =  "شبّيي اﻟ̣̣פﻟ̣̣و 𖠙 😿💔"
De_Alsh(msg.chat_id_, msg.id_, 1, DeProxTEAM, 1, 'md') 
return false
end
if text == 'باي' or text == 'بااي' or text == 'اروح' or text == 'اروح احسن' or text == 'اولي احسن' or text == 'راح اروح' or text == 'باي انام' then 
DeProxTEAM =  "أُرٌجُعُ عٍيدِهآآ مٍوو تنِْسةه 𖠙 🤤♥️"
De_Alsh(msg.chat_id_, msg.id_, 1, DeProxTEAM, 1, 'md') 
return false
end
if text == 'هلو' or text == 'هلاو' or text == 'هلا' or text == 'هلاوو' or text == 'هيلاو' or text == 'هيلاوو' or text == 'هلاا' then 
local DeProxTEAM = {"اࠗط็لق֯ق֯ هٞللاࠗ୨و 𖠙 🤤♥️" ,"هۂَلاا نۨہٰورتت يعمۘري 𖠙 🤤♥️" } 
DeAlsh2 = math.random(#DeProxTEAM) 
De_Alsh(msg.chat_id_, msg.id_, 1, DeProxTEAM[DeAlsh2] , 1, 'md') 
return false
end
...
local DeProxTEAM = {"ماﺷ͠ يةھَہّ يﻋ̝̚مريي ۅاﻧﺗ̲ت 𖠙 🤤♥️" ,"الحۡمۘدللهۂَ ٰوانۨہتت 𖠙 🤤♥️","تمۘامۘ عمۘري ٰوانۨہتت 𖠙 🤤♥️"} 
DeAlsh2 = math.random(#DeProxTEAM) 
De_Alsh(msg.chat_id_, msg.id_, 1, DeProxTEAM[DeAlsh2] , 1, 'md') 
return false
end
if text == 'وينك' or text == 'وينج' then
DeProxTEAM =  "مْوٌجہوٌدِ يہمْگُ يحلوُ 𖠙 😉♥️"
De_Alsh(msg.chat_id_, msg.id_, 1, DeProxTEAM, 1, 'md') 
return false
end
if text == 'بوت عواي' or text == 'بوت زربه' or text == 'البوت عاوي' or text == 'البوت زربه' then
DeProxTEAM =  "اطردكك تجرب ؟ ، 😕🔪"
De_Alsh(msg.chat_id_, msg.id_, 1, DeProxTEAM, 1, 'md') 
return false
end
if text == 'نايمين' or text == 'ميتين' then
DeProxTEAM =  "طُآمسين ووعٍيوونڪ 𖠙 😪🖤ۦ"
De_Alsh(msg.chat_id_, msg.id_, 1, DeProxTEAM, 1, 'md') 
return false
end
if text == 'هلوباي' or text == 'هلو باي' then  
DeProxTEAM =  "شحۡسۜيت مۘنۨہ هيجۚ ּكتبت ؟ 🌝♥️"
De_Alsh(msg.chat_id_, msg.id_, 1, DeProxTEAM, 1, 'md') 
return false
end
if text == 'اكلك' or text == 'اكلج' or text == 'اكلكم' then 
DeProxTEAM =  "ڪوولُِ مآڪوولُِ لُِآحٍدِ 𖠙 😉♥️"
De_Alsh(msg.chat_id_, msg.id_, 1, DeProxTEAM, 1, 'md')
return false
end
if text == 'فرخ' then
DeProxTEAM =  "ٰوينۨہهۂَ خۡل احۡصرهۂَ 𖠙 😹♥️" 
De_Alsh(msg.chat_id_, msg.id_, 1, DeProxTEAM, 1, 'md') 
return false
end
...
DeProxTEAM =  "لُِآ سوورس خآلُِتڪ دِي لُِڪ 𖠙 😒🔪" 
De_Alsh(msg.chat_id_, msg.id_, 1, DeProxTEAM, 1, 'md')
return false
end
end
...
DeAlsh:del(DeProx..'Alsh:Lock:Reply'..msg.chat_id_)
end end
if text == 'تعطيل ردود البوت' or text == 'تعطيل الردود' then
if DeAlsh:get(DeProx..'Alsh:Lock:Reply'..msg.chat_id_) then
De_Alsh(msg.chat_id_, msg.id_, 1, '⌁︙ردود البوت بالتاكيد معطله ', 1, 'md')
else
DeAlsh:set(DeProx..'Alsh:Lock:Reply'..msg.chat_id_,true)
