...
DeAlsh2 = math.random(#MilanuTEAM) 
De_Alsh(msg.chat_id_, msg.id_, 1, MilanuTEAM[DeAlsh2] , 1, 'md') 
return false
end
...
if text == 'سورس علش' or text == 'سورس بروكس' or text == 'سورس ديف ميلانو' or text == 'سورس زربه' or text == 'السورس زربه' or text == 'سورس عاوي' or text == 'السورس عاوي' then 
...
DeAlsh:del(Milanu..'Alsh:Lock:Reply'..msg.chat_id_)
end end
...
DeAlsh:set(Milanu..'Alsh:Lock:Reply'..msg.chat_id_,true)
